...
def main():
    ...
    parser.add_argument("--model-tag", type=str, default="gt",
                        help="Model tag for output filenames (e.g., colbertv2, colbertzero). "
                             "Output: scifact_{model_tag}_docs.jsonl")
    ...
    doc_path = output_dir / f"scifact_{args.model_tag}_docs.jsonl"
    doc_vec_counts = []
    ...
    query_path = output_dir / f"scifact_{args.model_tag}_queries.jsonl"
    query_vec_counts = []
    gt_counts = []
